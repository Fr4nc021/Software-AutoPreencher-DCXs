...
frame_rolagem = ctk.CTkFrame(tela)
frame_rolagem.pack(fill="both", expand=True)

# Adicionando a barra de rolagem
canvas = ctk.CTkCanvas(frame_rolagem)
canvas.pack(side="left", fill="both", expand=True)

scrollbar = ctk.CTkScrollbar(frame_rolagem, orient="vertical", command=canvas.yview)
...
ctk.CTkLabel(frame_conteudo, text="📄 Gerador de Documentos", font=("Arial", 16, "bold")).pack(pady=10)
