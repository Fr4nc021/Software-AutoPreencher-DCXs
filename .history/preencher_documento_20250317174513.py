...
if getattr(sys, 'frozen', False):  # Se estiver rodando como .exe
    ...
    base_path = os.path.dirname(__file__)  # Se estiver rodando como .py

# Definindo a pasta onde os modelos estão
pasta_modelos = os.path.join(base_path, "modelos")  # Certifique-se de que os arquivos estejam na pasta "modelos"
...
for key, path in modelos_disponiveis.items():
