...
campos = [
    ...
    ("Endereço Completo", "ENDEREÇO COMPLETO"), ("Cidade de Nascimento", "CIDADE DE NASCIMENTO"),
    ("Estado de Nascimento", "ESTADO DE NASCIMENTO"), ("Data de Nascimento", "DATA DE NASCIMENTO"),
    ("Nome do Pai", "NOME PAI"), ("Nome da Mãe", "NOME MÃE"), ("Data de Expedição", "DATA DE EXPEDIÇÃO DOCUMENTO"),
    ("Órgão Expedidor", "ÓRGÃO EXPEDIDOR"), ("Telefone", "TELEFONE")
]
entradas = {}
