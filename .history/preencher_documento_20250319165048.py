...
# Definindo um tamanho que respeita os limites da tela
max_width = int(screen_width * 0.9)  # 90% da largura da tela
max_height = int(screen_height * 0.8)  # 80% da altura da tela

# Configura o tamanho inicial, mínimo e máximo
tela.geometry(f"600x700")  # Tamanho inicial da janela
tela.minsize(400, 500)  # Tamanho mínimo da janela
tela.maxsize(max_width, max_height)  # Tamanho máximo da janela
